...
export default function OrderPage() {
    ...
    useEffect(() => {
        async function getSupabaseUser() {
            ...
            try {
                ...
                if (user) {
                    const { orders, address }: any = await getCurrentUserSingleOrder(user.id, orderid);
                    setOrders(orders);
                    setAddress(address);
                }
            } catch (err: any) {
    ...
    return (
        <div className="h-auto flex flex-col gap-10 py-8 px-4">
            <div className=" lg:px-5 xl:px-10 2xl:px-20 w-ful grid  grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-5 mx-auto">

                <Card className="border h-full border-gray-200 shadow-sm mb-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8" key={index}>
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            ...
                                            <p className="text-sm text-blue-600 underline cursor-pointer">{ }</p>
                                        </div>
