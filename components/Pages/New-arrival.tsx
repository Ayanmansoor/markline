...
function NewArrival() {
    ...
    return (
        <>
            ...
            <section className=' sm:h-[500px] px-5 lg:px-10 xl:px-20 2xl:px-40  relative flex flex-col-reverse sm:grid py-5  lg:py-10 grid-cols-1 sm:grid-cols-[1fr_1fr]  gap-3 sm:gap-1 '>
                ...
                isLoadingProducts ?
                    ...
                    allproducts.data &&
                        ...
                        <CategoriesSection title={"New In – Fresh Picks for You"} url=''  >
                            <CarouselProduct url={'product'} product={allproducts.data} css='grid-cols-2 md:grid-cols-3  lg:grid-cols-4 bg-gray-200 ' productsCardCss=' h-[230px] object-cover  sm:h-[300px] md:h-[350px] lg:h-[400px]' />
                        </CategoriesSection>
                        :
                        <div className="grid grid-cols-2 py-5 lg:py-10 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 items-start justify-start gap-3 px-5  lg:px-10   ">
                            <ProductCardSkeleton />
