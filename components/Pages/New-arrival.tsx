...
function NewArrival() {
    ...
    return (
        <>
            ...
            <section className=' sm:h-[500px] relative flex flex-col-reverse sm:grid py-5 grid-cols-1 sm:grid-cols-[1fr_1fr]  gap-3 sm:gap-10 px-5 lg:px-10 xl:px-20 2xl:px-40 '>
