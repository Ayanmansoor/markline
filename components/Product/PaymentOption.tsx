...
function PaymentOption({ orderID, email, username }: orderData) {
  ...
  return (
    <><div className='fixed top-0  w-full h-full pointer-events-none right-0 left-0  z-50 confetti' ref={container}></div><section className='w-full  flex flex-col items-start justify-between  h-[300px]   p-10'>
