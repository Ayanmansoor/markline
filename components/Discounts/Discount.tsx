    ...
    return (
        <>
            <section className='w-full mb-10 relative h-auto bg-black  py-5 md:py-10 border '>
                ...
                grid grid-cols-1  justify-between  md:gap-0 md:grid-cols-[2fr_1.5fr]  gap-10 px-5 lg:px-10 xl:px-20 2xl:px-40 '>

                    <div className='w-full relative h-full flex items-start   justify-center flex-col gap-1    '>
                        <h2 className=' text-xl lg:text-2xl capitalize font-semibold text-white '>{title}</h2>
                        <p className=' text-xs sm:text-sm md:text-sm font-normal w-full md:w-4/5 text-white line-clamp-2 md:line-clamp-3 '>{description}</p>
                    ...
                    <Link href={url || ""}>
                        ...
                        >
                            ...
                            <SwiperSlide className='max-w-[100px] lg:max-w-[200px] h-full relative flex items-center justify-center'>
                                <img src="/block-heel-mules-for-women-5.jpeg" height={400} width={400} className='w-full relative h-full object-cover cursor-pointer ' alt="Markline || Markline || buy online" loading='lazy' />
                            </SwiperSlide>
                            <SwiperSlide className='max-w-[100px] lg:max-w-[200px] h-full relative flex items-center justify-center'>
