...
function MiniCollectionCard({ collections, url }: newCollectionCardProps) {
    ...
    return (
        <Link href={`/collections/${url}/${collections.slug}`} className=' w-[170px] md:w-[190px] lg:w-[200px] overflow-hidden  max-h-[260px]      cursor-pointer relative group  flex flex-col items-start justify-center gap-4 p-1 md:p-3     '>
