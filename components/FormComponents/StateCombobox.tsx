    ...
    return (
        <>
            <div className='w-full relative h-auto flex flex-col gap-1  '>
                ...
                <select value={selectedState || ""} className="w-full text-sm font-normal text-gray-500 relative h-auto py-2 border border-gray-200 px-2 rounded-md" onChange={selectStateName} >
