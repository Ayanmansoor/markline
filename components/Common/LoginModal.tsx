            ...
            <DialogContent className="max-w-[calc(100vw-20px)] h-auto rounded-md lg:max-h-[500px] p-0 grid grid-cols-1 md:grid-cols-2 items-start gap-1 sm:max-w-[300px] md:max-w-[600px] xl:max-w-[700px]">
                ...
                >
                    ...
                    <section className="w-full flex flex-col gap-3 mt-2">
                        ...
                        <button
                            disabled={isSending}
                            className="text-base rounded-lg w-fit self-end font-medium border bg-primary text-white border-white cursor-pointer px-10 py-2 hover:bg-white hover:text-primary hover:border-primary transition-all duration-75"
                        >
