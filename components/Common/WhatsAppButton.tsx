...
const WhatsAppButton = ({ product, variant }: WhatsAppButtonProps) => {
    ...
    return (
        <button
            ...
            className="flex w-full items-center justify-center gap-3 bg-[#128C7E] text-white px-2 sm:px-6 py-4 font-bold uppercase text-xs rounded-none transition-transform "
        >
