        ...
        <section className='w-full relative  h-auto items-start gap-5  py-10 lg:py-20  flex flex-col  px-3 md:px-5 lg:px-10    '>
            <div className='w-full relative h-auto flex items-center flex-col-reverse sm:flex-row  justify-between gap-2'>
                <span className='flex flex-col gap-3 '>
                    {
                        isH1 ? 
                          <h1 className='    text-sm sm:text-base md:text-2xl xl:text-3xl self-start  font-medium   w-fit  uppercase   '>{title}</h1>                        
                        :
                          <h2 className='   text-sm sm:text-base   md:text-2xl xl:text-3xl  font-medium     uppercase self-start   w-fit  '>{title}</h2>
                    }
                    {
                        subtitle &&
