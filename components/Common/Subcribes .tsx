  ...
  return (
    <section className='w-full  bg-black border-b border-white  flex items-center justify-center px-4 lg:px-10   '>
      ...
      <div className='relative h-auto  flex flex-col gap-4 w-full  lg:w-[50%] py-10 '>
        <h2 className=' text-base md:text-lg  lg:text-2xl font-semibold text-white uppercase text-center'>Stay in Style with Markline</h2>
        <form action="" onSubmit={handleSubmit(onSubmit)} className='w-full relative h-auto flex items-center  justify-between gap-2'>
          ...
          <button className=' text-base text-white bg-black border border-white px-3 md:px-5 lg:px-10 py-2 hover:bg-white hover:text-primary ' disabled={submitting}>{submitting ? 'Submitting...' : "Submit"}</button>
